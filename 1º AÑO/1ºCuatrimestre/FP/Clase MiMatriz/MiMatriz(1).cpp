...
class MiMatriz
{
	...
	void intercambiar_filas(int fila1 , int fila2 , MiMatriz m)  /*Esta funcion intercambia las filas dadas como argumento */
	{
		int tmp ; 
...
int main () {
	...
	MatrizEspiral () ; 		//Se llama a la funcion para generar la matriz espiral  
										...
										//Se llama a la funcion para generar la matriz espiral  
