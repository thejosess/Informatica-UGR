...
public class MagicNumbers {
    ...
    public static int max_recursion_depth = 1530; // assuming java -Xmx512M se ha puesto el doble
    public static int max_recursion_count = 4096; // se ha puesto el doble
