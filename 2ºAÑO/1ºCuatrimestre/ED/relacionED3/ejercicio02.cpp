		...
		// y si utilizo otro TDA?
	{
		...
		else if(!subimos)
		{
			...
			else
			{
				...
				else	//se me queda en bucle infinito subiendo a padre y bajando
						// a la derecha, creo que habria que hacer dos while
						// pero eso es muy poco eficiente y tengo dudas
				{
					subimos = true;
					nodo = nodo.parent();
				}
